...
//                shadow.setVisibility(View.VISIBLE);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.notice_write_image);
...
//        File file = new File (getPath(photoURI));
        ...
        service.boardSave(titleRequest,contentRequest,departmentRequest,body).enqueue(new Callback<RetrofitNotice>() {
            @Override
