...
*/
public class ContactListAdapterManager extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContactListAdapterManager(Context context, List<ContactListItem> items, FragmentManager fragmentManager) {
        this.mCtx=context;
        this.items=items;
